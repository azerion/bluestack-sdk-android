...
In Android, we don’t have the option to directly detect whether the app is in  background or not like applicationdidenterbackground in iOS. But There are few workarounds. 
